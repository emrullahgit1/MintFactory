...
#[derive(Debug)]
pub struct MintFactoryProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MintFactoryProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MintFactory processing");
    
    let mut processor = MintFactoryProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MintFactoryProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MintFactoryProcessor::new(false);
